...
# Data dir needs to contain GTFS.zip file and OpenStreetMap data in Protobuf format (*.pbf)
# You can download example data from here:
# https://github.com/AccessibilityRG/HelsinkiRegionTravelTimeMatrix2018/tree/master/codes/tests/comparisons-against-Google-and-OTP/data
